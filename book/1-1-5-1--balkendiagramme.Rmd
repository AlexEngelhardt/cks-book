...
Wir benutzen die Daten aus dem Artikel zu [Häufigkeitstabellen](#sec-haeufigkeitstabellen):
...
Damit zeichnen wir nun ein Balkendiagramm für die absolute (die Spalte \(h_i\)) und relative (die Spalte \(f_i\)) Häufigkeit für jedes Semester.
```
