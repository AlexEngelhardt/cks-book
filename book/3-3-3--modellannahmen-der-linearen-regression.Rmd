...
```{r regression-annahmen-1, fig.cap="(ref:regression-annahmen-1-caption)"}
knitr::include_graphics("img/regression-annahmen-1.png")
```
...
```{r regression-annahmen-2, fig.cap="(ref:regression-annahmen-2-caption)"}
knitr::include_graphics("img/regression-annahmen-2.png")
```
...
```{r regression-annahmen-3, fig.cap="(ref:regression-annahmen-3-caption)"}
knitr::include_graphics("img/regression-annahmen-3.png")
```
...
```{r regression-annahmen-4, fig.cap="(ref:regression-annahmen-4-caption)"}
knitr::include_graphics("img/regression-annahmen-4.png")
```
...
knitr::include_graphics("img/regression-annahmen-5.png")
```
