...
Grafisch kann man sich das schön veranschaulichen. Das Residuum für eine Beobachtung ist der farbig markierte Abstand in Abbildung \@ref(fig:regression-residuen-1).
...
```{r regression-residuen-1, fig.cap="(ref:regression-residuen-1-caption)"}
knitr::include_graphics("img/regression-residuen-1.png")
```
