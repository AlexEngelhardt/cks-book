...
(ref:verteilungen-chisq-verteilung-verteilungstabelle-caption) Ablesebeispiel der \(\chi^2\)-Verteilung mit \(df=5\) Freiheitsgraden. Die Dichte (obere Grafik) hat ab der Stelle \(x=11.07\) noch eine Fläche von 5%. Die Verteilungsfunktion (untere Grafik) an der Stelle \(x=11.07\) hat genau den Wert 0.95.

```{r verteilungen-chisq-verteilung-verteilungstabelle, fig.cap="(ref:verteilungen-chisq-verteilung-verteilungstabelle-caption)"}
