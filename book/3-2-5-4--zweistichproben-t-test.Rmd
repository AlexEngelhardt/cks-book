...
```{r hypothesentests-dt12-right, fig.cap="(ref:hypothesentests-dt12-right-caption)"}
knitr::include_graphics("img/hypothesentests-dt12-right.png")
```
