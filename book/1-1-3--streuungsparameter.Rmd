...
```{r spannweite, fig.height=3.5, fig.cap="Die Spannweite ist die Differenz zwischen dem größten und dem kleinsten Wert einer Datenreihe"}
...
```{r interquartilsabstand, fig.height=3.5, fig.cap="(ref:iqr-caption)"}
