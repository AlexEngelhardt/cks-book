...
Table: (#tab:spearman-table1) Zwei gleiche Ränge
...
In Tabelle \@ref(tab:spearman-table1) haben zwei Personen dasselbe Alter, deren Ränge 2 und 3 wären. Daher bekommen beide Personen den Durchschnittsrang 2.5.

Table: (#tab:spearman-table2) Drei gleiche Ränge
...
In Tabelle \@ref(tab:spearman-table2) haben drei Personen dasselbe Alter. Deren Ränge wären 3, 4, und 5. Der resultierende Durchschnittsrang für alle drei Personen ist also 4.
