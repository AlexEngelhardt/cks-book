...
Mit der Spearman-Korrelation misst man ebenso wie mit der [Pearson-Korrelation](#sec-pearson-korrelation) den Zusammenhang zwischen zwei Variablen. Er nimmt ebenso Werte von -1 (perfekte negative Korrelation) bis +1 (perfekte positive Korrelation) an, und ist nahe bei 0, falls gar keine Korrelation vorliegt.
