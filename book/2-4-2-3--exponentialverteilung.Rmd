...
(ref:verteilungen-exponentialverteilung-verteilungsfunktion-caption) Verteilungsfunktion der Exponentialverteilung mit \(\lambda=0.5\).

```{r verteilungen-exponentialverteilung-verteilungsfunktion, fig.cap="(ref:verteilungen-exponentialverteilung-verteilungsfunktion-caption)"}
