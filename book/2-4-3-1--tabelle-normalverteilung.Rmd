...
in den Spalten ist die erste Nachkommastelle von \(z\) ab, in den Spalten die zweite Nachkommastelle. So ist z.B. der Wert in der Ecke ganz rechts oben der von \(\Phi(0.09) = 0.5359\). Eine Zeile direkt darunter ist der Wert für \(\Phi(0.19) = 0.5753\).
