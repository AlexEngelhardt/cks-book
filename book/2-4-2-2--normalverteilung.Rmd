...
```{r verteilungen-normalverteilung-mu-sigma, fig.cap="(ref:verteilungen-normalverteilung-mu-sigma-caption)"}
knitr::include_graphics("img/verteilungen-normalverteilung-mu-sigma.png")
```
...
```{r verteilungen-normalverteilung-skizze, fig.cap="(ref:verteilungen-normalverteilung-skizze-caption)"}
knitr::include_graphics("img/verteilungen-normalverteilung-skizze.png")
```
...
(ref:verteilungen-normalverteilung-verteilungsfunktion-caption) Verteilungsfunktion \(\Phi(z)\) der Standardnormalverteilung (also mit \(\mu=0\) und \(\sigma^2=1\)).

```{r verteilungen-normalverteilung-verteilungsfunktion, fig.cap="(ref:verteilungen-normalverteilung-verteilungsfunktion-caption)"}
knitr::include_graphics("img/verteilungen-normalverteilung-verteilungsfunktion.png")
```
...
```{r verteilungen-normalverteilung-standardisierung, fig.cap="(ref:verteilungen-normalverteilung-standardisierung-caption)"}
knitr::include_graphics("img/verteilungen-normalverteilung-standardisierung.png")
```
