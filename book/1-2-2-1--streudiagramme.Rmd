...
```{r zweivariablen-streudiagramm-bsp, fig.cap="Ein Streudiagramm von Bremsweg vs. Geschwindigkeit."}
knitr::include_graphics("img/zweivariablen-streudiagramm-bsp.png")
```
...
knitr::include_graphics("img/zweivariablen-streudiagramme-3d.png")
```
...
```{r zweivariablen-streudiagramme-2d, fig.cap="Ein 3d-Streudiagramm."}
knitr::include_graphics("img/zweivariablen-streudiagramme-2d.png")
```