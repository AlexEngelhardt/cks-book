...
```{r verteilungen-diskrete-gleichverteilung-dichte, fig.cap="(ref:verteilungen-diskrete-gleichverteilung-dichte-caption)"}
knitr::include_graphics("img/verteilungen-diskrete-gleichverteilung-dichte.png")
```
...
(ref:verteilungen-diskrete-gleichverteilung-verteilungsfunktion-caption) Verteilungsfunktion der diskreten Gleichverteilung beim Experiment "Werfen eines Würfels"

```{r verteilungen-diskrete-gleichverteilung-verteilungsfunktion, fig.cap="(ref:verteilungen-diskrete-gleichverteilung-verteilungsfunktion-caption)"}
knitr::include_graphics("img/verteilungen-diskrete-gleichverteilung-verteilungsfunktion.png")
```
