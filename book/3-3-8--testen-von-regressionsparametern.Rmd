...
(ref:regression-testen-1-caption) Streudiagramm der Zielgröße \(y\)=Körpergewicht vs. der beiden Einflussgrößen "Körpergröße" und "Hausnummer".

```{r regression-testen-1, fig.cap="(ref:regression-testen-1-caption)"}
knitr::include_graphics("img/regression-testen-1.png")
```
...
```{r regression-testen-2, fig.cap="(ref:regression-testen-2-caption)"}
knitr::include_graphics("img/regression-testen-2.png")
```
...
| Grösse \(b_1\)     | 0.730    | 0.175          | 4.181       | 0.001  |
...
```{r regression-testen-3, fig.cap="(ref:regression-testen-3-caption)"}
knitr::include_graphics("img/regression-testen-3.png")
```
