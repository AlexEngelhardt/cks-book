## Darstellung und Eigenschaften von diskreten Zufallsvariablen {#sec-duevdz}
...
```{r zufallsvariablen-dichte-verteilung, fig.cap="(ref:zufallsvariablen-dichte-verteilung-caption)"}
knitr::include_graphics("img/zufallsvariablen-dichte-verteilung.png")
```
...
```{r zufallsvariablen-varianz, fig.cap="(ref:zufallsvariablen-varianz-caption)"}
knitr::include_graphics("img/zufallsvariablen-varianz.png")
```
