...
(ref:regression-gerade-caption) Die fertige Regressionsgerade für unser Beispiel mit der Ringgröße.

```{r regression-gerade, fig.cap="(ref:regression-gerade-caption)"}
