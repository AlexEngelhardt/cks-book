...
Die einzelnen Buchstaben sind im Kapitel \@ref(sec-kreuztabellen) zu [Kreuztabellen](#sec-kreuztabellen) erklärt. Wenn man die erwarteten Häufigkeiten \(e_{ij}\) nun auch noch ausschreibt (sie sind ja \(e_{ij} = \frac{h_{i\cdot} \cdot h_{\cdot j}}{n}\)), kommt man zur oft gesehenen, aber sehr komplizierten Formel
